namespace SpaceEquipmentLtd.NanobotBuildAndRepairSystem
{
   ...
   [MyEntityComponentDescriptor(typeof(MyObjectBuilder_ShipWelder), false, "STC_Shipyard", "SELtdSmallNanobotBuildAndRepairSystem")]
   public class NanobotBuildAndRepairSystemBlock : MyGameLogicComponent
   {
      ...
      public void SettingsChanged()
      {
         ...
         if (maxMultiplier > 20) NeedsUpdate = MyEntityUpdateEnum.EACH_FRAME | MyEntityUpdateEnum.EACH_10TH_FRAME;
